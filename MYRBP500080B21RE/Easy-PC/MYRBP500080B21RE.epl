SamacSys ECAD Model
16681249/122786/2.50/9/3/Power Supply
...
(library Library_1
	...
	(patternDef "MYRBP500080B21RE" (originalName "MYRBP500080B21RE")
		(multiLayer
	...
	(symbolDef "MYRBP500080B21RE" (originalName "MYRBP500080B21RE")
	...
	(compDef "MYRBP500080B21RE" (originalName "MYRBP500080B21RE") (compHeader (numPins 9) (numParts 1) (refDesPrefix PS)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MYRBP500080B21RE"))
		(attachedPattern (patternNum 1) (patternName "MYRBP500080B21RE")
			(numPads 9)
			(padPinMap
		...
		(attr "Mouser Part Number" "81-MYRBP500080B21RE")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Murata-Electronics/MYRBP500080B21RE?qs=hd1VzrDQEGi2HKFlO8%252BP9Q%3D%3D")
		(attr "Manufacturer_Name" "Murata Electronics")
		(attr "Manufacturer_Part_Number" "MYRBP500080B21RE")
		(attr "Description" "Non-Isolated DC/DC Converters")
