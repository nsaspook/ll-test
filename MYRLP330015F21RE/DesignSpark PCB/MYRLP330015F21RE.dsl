SamacSys ECAD Model
17433392/122786/2.50/9/3/Power Supply
...
(library Library_1
	...
	(patternDef "MYRLP330015F21RE" (originalName "MYRLP330015F21RE")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r130_90) (pt 0.000, 0.000) (rotation 90))
		)
		...
		(layerContents (layerNumRef 18)
			(arc (pt -0.55, -1.55) (radius 0.05) (startAngle 270) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.55 -1.5) (pt -0.55 -1.5) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -0.55, -1.55) (radius 0.05) (startAngle 90.0) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "MYRLP330015F21RE" (originalName "MYRLP330015F21RE")
	...
	(compDef "MYRLP330015F21RE" (originalName "MYRLP330015F21RE") (compHeader (numPins 9) (numParts 1) (refDesPrefix PS)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MYRLP330015F21RE"))
		(attachedPattern (patternNum 1) (patternName "MYRLP330015F21RE")
			(numPads 9)
			(padPinMap
		...
		(attr "Mouser Part Number" "580-MYRLP330015F21RE")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Murata-Power-Solutions/MYRLP330015F21RE?qs=vvQtp7zwQdNOX7V%2FydgWKA%3D%3D")
		(attr "Manufacturer_Name" "Murata Electronics")
		(attr "Manufacturer_Part_Number" "MYRLP330015F21RE")
		(attr "Description" "Non-Isolated DC/DC Converters 150mA 1.8-6.0Vin 3.30Vout -40 to 85degC PWM")
		(attr "Datasheet Link" "https://www.murata.com/products/productdata/8816917708830/MYRLP-F.pdf?1656300615000")
		(attr "Height" "1.04 mm")
	)
