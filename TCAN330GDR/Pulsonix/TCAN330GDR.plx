...
//1188906/122786/2.50/8/3/Undefined or Miscellaneous
...
(library Library_1
	...
	(symbolDef "TCAN330GDR" (originalName "TCAN330GDR")
	...
	(compDef "TCAN330GDR" (originalName "TCAN330GDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix U)
		)
		(compPin "1" (pinName "TXD") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(compPin "4" (pinName "RXD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Output))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TCAN330GDR"))
		...
		(attr "Mouser Part Number" "595-TCAN330GDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TCAN330GDR?qs=9DwIlvx97adeWwzxdqwSPw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TCAN330GDR")
		...
		(attr "<STEP Filename>" "TCAN330GDR.stp")
